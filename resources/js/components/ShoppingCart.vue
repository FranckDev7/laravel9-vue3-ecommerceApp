<template>
    <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Votre panier d'achats</h2>
            ...
            <div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
                <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                         ...
                         <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                             <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                 ...
                                 <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                     <!-- PRODUCT NAME -->
                                     <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white" v-text="product.name"></a>

                                     <!-- UNIT PRICE -->
                                     <p class="text-sm text-gray-500 dark:text-gray-400">
                                         Prix unitaire : <span v-text="formatPrice(product.price)"></span>
                                     </p>

                                     <p class="text-sm text-gray-600" v-text="product.attributes.description"></p>
                    ...
                    <!-- Dans le template -->
                    <div v-if="!isLoading && products.length > 0" class="w-full mt-6 lg:w-1/4">
                        <Button
                            color="danger"
                            size="md"
                    ...
                    <div v-else-if="!isLoading && products.length === 0" class="w-full mt-6 text-center text-gray-500 dark:text-gray-400">
...
const {
    ...
    destroyProduct,
    cartCount,
    clearCartApi,   // ✅ fonction dans le composable pour vider le panier côté API
} = useProduct()
...
/**
 * reduce() : méthode des instances de Array qui exécute une fonction de rappel « reducer »
 * fournie par l'utilisateur sur chaque élément du tableau.
 * Object.value : rétourne un tableau des valeurs de proprietés d'un Objet donné
 */
...
const clearCart = async () => {
    try {
        await clearCartApi()           // Appelle l'API pour vider le panier
        products.value = []            // Vide le tableau local
        emitter.emit('cartCountUpdated', 0)
